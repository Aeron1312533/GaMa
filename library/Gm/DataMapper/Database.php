 ...
 */
abstract class Gm_DataMapper_Database extends Gm_DataMapper_Abstract {
       
    public function insert($entity) {
        try {
            if (!is_a($entity, $this->getEntityClass())) {
                throw new Gm_DataMapper_Exception('DataMapper: - Inserting invalid entity');
            }
            ...
            throw new Gm_DataMapper_Exception('DataMapper: - DBERROR: ' . $e->getMessage());
        } catch (Gm_DataMapper_Exception $e) {
            throw $e;
        } catch (Exception $e) {
            throw new Gm_DataMapper_Exception('DataMapper: - INTERNALERROR: ' . $e->getMessage());
        }
    ...
    public function update($entity) {
         try {
            if (!is_a($model, $this->getModelClass())) {
                throw new Gm_DataMapper_Exception('DataMapper: - Updating invalid model ');
            }
